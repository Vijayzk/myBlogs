  ...
  return (
    <>
      ...
      <div className={`mt-10 lg:mt-20 lg:px-10 ${postLoader || posts?.length == 0 ? `flex justify-center items-center` : `grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6`} lg:mb-10 scroll-smooth`}>
        ...
        {/* Blog Details */}
        <dialog id='my_modal_3' className='fixed top-30 left-7 md:left-1/6 lg:top-20 lg:left-1/3 rounded-4xl px-4 lg:px-10'>
          <div className='flex flex-row justify-center w-[260px] h-[480px] md:w-[420px] lg:w-[500px] lg:h-[460px] bg-white rounded-4xl px-2 md:px-5 mb-5 lg:mb-14 pt-10 lg:pt-0'>
