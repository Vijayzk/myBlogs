...
const Footer = () => {
    return (
        <footer className="footer footer-horizontal footer-center bg-[#F9F5FF] rounded p-10 text-[#6941C6]">
            <nav className="grid grid-flow-col gap-4 text-[#6941C6]">
            ...
            <aside>
                <p>Copyright © {new Date().getFullYear()} - All right reserved by my<span className='font-semibold'>Blogs</span></p>
            </aside>
        </footer>
    )
}
